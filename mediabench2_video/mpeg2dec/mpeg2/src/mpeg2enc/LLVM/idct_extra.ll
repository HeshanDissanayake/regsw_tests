...
define dso_local void @idct(ptr nocapture noundef %0) local_unnamed_addr #0 {
  br label %4
...
4:                                                ; preds = %1, %104
  ...
  %23 = or i32 %19, %22
  %24 = getelementptr inbounds i8, ptr %7, i64 14
  ...
  %31 = or i32 %27, %30
  %32 = getelementptr inbounds i8, ptr %7, i64 6
  %33 = load i16, ptr %32, align 2, !tbaa !6
  %34 = sext i16 %33 to i32
  %35 = or i32 %31, %34
  %36 = icmp eq i32 %35, 0
  %37 = load i16, ptr %7, align 2, !tbaa !6
  br i1 %36, label %38, label %40

38:                                               ; preds = %4
  %39 = shl i16 %37, 3
  store i16 %39, ptr %24, align 2, !tbaa !6
  store i16 %39, ptr %12, align 2, !tbaa !6
  br label %104
...
40:                                               ; preds = %4
  ...
  store i16 %100, ptr %12, align 2, !tbaa !6
  %101 = sub nsw i32 %68, %64
  %102 = lshr i32 %101, 8
  %103 = trunc i32 %102 to i16
  store i16 %103, ptr %24, align 2, !tbaa !6
  br label %104
...
113:                                              ; preds = %2, %241
  ...
  %120 = getelementptr inbounds i8, ptr %115, i64 96
  %121 = load i16, ptr %120, align 2, !tbaa !6
  %122 = sext i16 %121 to i32
  %123 = or i32 %119, %122
  %124 = getelementptr inbounds i8, ptr %115, i64 32
  %125 = load i16, ptr %124, align 2, !tbaa !6
  %126 = sext i16 %125 to i32
  %127 = or i32 %123, %126
  %128 = getelementptr inbounds i8, ptr %115, i64 16
  %129 = load i16, ptr %128, align 2, !tbaa !6
  %130 = sext i16 %129 to i32
  %131 = or i32 %127, %130
  %132 = getelementptr inbounds i8, ptr %115, i64 112
  %133 = load i16, ptr %132, align 2, !tbaa !6
  %134 = sext i16 %133 to i32
  %135 = or i32 %131, %134
  %136 = getelementptr inbounds i8, ptr %115, i64 80
  %137 = load i16, ptr %136, align 2, !tbaa !6
  %138 = sext i16 %137 to i32
  %139 = or i32 %135, %138
  %140 = getelementptr inbounds i8, ptr %115, i64 48
  %141 = load i16, ptr %140, align 2, !tbaa !6
  %142 = sext i16 %141 to i32
  %143 = or i32 %139, %142
  %144 = icmp eq i32 %143, 0
  %145 = load i16, ptr %115, align 2, !tbaa !6
...
147:                                              ; preds = %113
  ...
  %152 = load i16, ptr %151, align 2, !tbaa !6
  store i16 %152, ptr %132, align 2, !tbaa !6
  store i16 %152, ptr %120, align 2, !tbaa !6
  store i16 %152, ptr %136, align 2, !tbaa !6
  store i16 %152, ptr %116, align 2, !tbaa !6
  store i16 %152, ptr %140, align 2, !tbaa !6
  store i16 %152, ptr %124, align 2, !tbaa !6
  store i16 %152, ptr %128, align 2, !tbaa !6
  store i16 %152, ptr %115, align 2, !tbaa !6
  br label %241
...
define dso_local void @init_idct() local_unnamed_addr #1 {
  store ptr getelementptr inbounds (i8, ptr @iclip, i64 1024), ptr @iclp, align 8, !tbaa !10
  br label %1
...
1:                                                ; preds = %0, %1
  ...
  %7 = getelementptr inbounds i16, ptr getelementptr inbounds (i8, ptr @iclip, i64 1024), i64 %2
  store i16 %6, ptr %7, align 2, !tbaa !6
  %8 = add nsw i64 %2, 1
  %9 = icmp eq i64 %8, 512
...
attributes #1 = { nofree norecurse nosync nounwind memory(write, argmem: none, inaccessiblemem: none) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic-rv64" "target-features"="+64bit,+a,+d,+f,+m,+relax,+zicsr,+zifencei,-c,-e,-experimental-smmpm,-experimental-smnpm,-experimental-ssnpm,-experimental-sspm,-experimental-ssqosid,-experimental-supm,-experimental-zalasr,-experimental-zfbfmin,-experimental-zicfilp,-experimental-zicfiss,-experimental-ztso,-experimental-zvfbfmin,-experimental-zvfbfwma,-h,-shcounterenw,-shgatpa,-shtvala,-shvsatpa,-shvstvala,-shvstvecd,-smaia,-smepmp,-smstateen,-ssaia,-ssccptr,-sscofpmf,-sscounterenw,-ssstateen,-ssstrict,-sstc,-sstvala,-sstvecd,-ssu64xl,-svade,-svadu,-svbare,-svinval,-svnapot,-svpbmt,-v,-xcvalu,-xcvbi,-xcvbitmanip,-xcvelw,-xcvmac,-xcvmem,-xcvsimd,-xsfcease,-xsfvcp,-xsfvfnrclipxfqf,-xsfvfwmaccqqq,-xsfvqmaccdod,-xsfvqmaccqoq,-xsifivecdiscarddlone,-xsifivecflushdlone,-xtheadba,-xtheadbb,-xtheadbs,-xtheadcmo,-xtheadcondmov,-xtheadfmemidx,-xtheadmac,-xtheadmemidx,-xtheadmempair,-xtheadsync,-xtheadvdot,-xventanacondops,-za128rs,-za64rs,-zaamo,-zabha,-zacas,-zalrsc,-zama16b,-zawrs,-zba,-zbb,-zbc,-zbkb,-zbkc,-zbkx,-zbs,-zca,-zcb,-zcd,-zce,-zcf,-zcmop,-zcmp,-zcmt,-zdinx,-zfa,-zfh,-zfhmin,-zfinx,-zhinx,-zhinxmin,-zic64b,-zicbom,-zicbop,-zicboz,-ziccamoa,-ziccif,-zicclsm,-ziccrse,-zicntr,-zicond,-zihintntl,-zihintpause,-zihpm,-zimop,-zk,-zkn,-zknd,-zkne,-zknh,-zkr,-zks,-zksed,-zksh,-zkt,-zmmul,-zvbb,-zvbc,-zve32f,-zve32x,-zve64d,-zve64f,-zve64x,-zvfh,-zvfhmin,-zvkb,-zvkg,-zvkn,-zvknc,-zvkned,-zvkng,-zvknha,-zvknhb,-zvks,-zvksc,-zvksed,-zvksg,-zvksh,-zvkt,-zvl1024b,-zvl128b,-zvl16384b,-zvl2048b,-zvl256b,-zvl32768b,-zvl32b,-zvl4096b,-zvl512b,-zvl64b,-zvl65536b,-zvl8192b" }
