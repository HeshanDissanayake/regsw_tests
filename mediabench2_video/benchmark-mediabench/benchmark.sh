...
./cjpeg -dct int -quality 13 -outfile output_base_4CIF_96bps.jpg ../input_data/input_base_4CIF.ppm
./djpeg -dct int -ppm -outfile output_base_4CIF_96bps_dec.ppm ../input_data/input_base_4CIF_96bps.jpg
cd ../../
echo " |-------------------------------------------| "
...
./tmndec -o3 ../input_data/input_base_4CIF_96bps.263 output_base_4CIF_96bps_dec
cd /home/tmn-1.7-build
./tmn -x 4 -a 0 -b 8 -s 15 -G -R 30.00 -r 3508000 -S 3 -Z 30.0 -O 0 -i ../input_data/input_base_4CIF_0to8.yuv -o output_base_4CIF_96bps_15.raw -B output_base_4CIF_96bps_15.263
