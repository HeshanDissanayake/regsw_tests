...
@.str = private unnamed_addr constant [53 x i8] c"GIF input is unsupported for legal reasons.  Sorry.\0A\00", align 1

; Function Attrs: noreturn nounwind
define dso_local noalias noundef nonnull ptr @jinit_read_gif(ptr nocapture noundef readnone %0) local_unnamed_addr #0 {
  %2 = load ptr, ptr @stderr, align 8, !tbaa !6
  %3 = tail call i64 @fwrite(ptr nonnull @.str, i64 52, i64 1, ptr %2) #2
  tail call void @exit(i32 noundef signext 1) #3
  unreachable
}
