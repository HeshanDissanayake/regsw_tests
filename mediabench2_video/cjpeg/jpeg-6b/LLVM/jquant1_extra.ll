...
44:                                               ; preds = %44, %41
  ...
  br i1 %49, label %50, label %44, !llvm.loop !31
...
84:                                               ; preds = %82, %84
  ...
  %89 = load i32, ptr %70, align 8, !tbaa !34
  %90 = icmp eq i32 %89, 2
  ...
  br i1 %99, label %151, label %84, !llvm.loop !36
...
105:                                              ; preds = %125, %100
  ...
  %108 = load i32, ptr %70, align 8, !tbaa !34
...
125:                                              ; preds = %114
  store i32 %121, ptr %117, align 4, !tbaa !35
  %126 = trunc i64 %123 to i32
  %127 = add nuw nsw i64 %106, 1
  %128 = icmp eq i64 %127, %68
  br i1 %128, label %129, label %105, !llvm.loop !37

129:                                              ; preds = %125
  %130 = load i32, ptr %70, align 8, !tbaa !34
  br label %131
...
157:                                              ; preds = %151
  %158 = load i32, ptr %34, align 4, !tbaa !35
...
183:                                              ; preds = %232, %181
  %184 = phi i32 [ %179, %181 ], [ %233, %232 ]
  %185 = phi i64 [ 0, %181 ], [ %234, %232 ]
  %186 = phi i32 [ %152, %181 ], [ %190, %232 ]
  %187 = getelementptr inbounds [4 x i32], ptr %34, i64 0, i64 %185
...
192:                                              ; preds = %183
  ...
  %198 = getelementptr inbounds ptr, ptr %178, i64 %185
...
203:                                              ; preds = %209, %199
  %204 = phi i64 [ 0, %199 ], [ %210, %209 ]
  %205 = phi i64 [ 0, %199 ], [ %211, %209 ]
  %206 = trunc i64 %204 to i32
  %207 = mul i32 %190, %206
  %208 = icmp slt i32 %207, %152
  br i1 %208, label %213, label %209

209:                                              ; preds = %227, %203
  %210 = add nuw nsw i64 %204, 1
  %211 = add nuw nsw i64 %205, %200
  %212 = icmp eq i64 %210, %202
  br i1 %212, label %230, label %203, !llvm.loop !42

213:                                              ; preds = %203
  %214 = mul nuw nsw i64 %204, 255
  %215 = add nuw nsw i64 %214, %195
  %216 = udiv i64 %215, %196
  %217 = trunc i64 %216 to i8
  br label %218

218:                                              ; preds = %227, %213
  %219 = phi i64 [ %228, %227 ], [ %205, %213 ]
  br label %220

220:                                              ; preds = %220, %218
  %221 = phi i64 [ %225, %220 ], [ 0, %218 ]
  %222 = load ptr, ptr %198, align 8, !tbaa !23
  %223 = getelementptr i8, ptr %222, i64 %221
  %224 = getelementptr i8, ptr %223, i64 %219
  store i8 %217, ptr %224, align 1, !tbaa !28
  %225 = add nuw nsw i64 %221, 1
  %226 = icmp eq i64 %225, %200
  br i1 %226, label %227, label %220, !llvm.loop !43

227:                                              ; preds = %220
  %228 = add nsw i64 %219, %201
  %229 = icmp slt i64 %228, %182
  br i1 %229, label %218, label %209, !llvm.loop !44

230:                                              ; preds = %209
  %231 = load i32, ptr %11, align 8, !tbaa !24
  br label %232

232:                                              ; preds = %230, %192, %183
  %233 = phi i32 [ %231, %230 ], [ %184, %183 ], [ %184, %192 ]
  %234 = add nuw nsw i64 %185, 1
  %235 = sext i32 %233 to i64
  %236 = icmp slt i64 %234, %235
  br i1 %236, label %183, label %237, !llvm.loop !45

237:                                              ; preds = %232, %168
  %238 = getelementptr inbounds i8, ptr %33, i64 32
  store ptr %178, ptr %238, align 8, !tbaa !46
  %239 = getelementptr inbounds i8, ptr %33, i64 40
  store i32 %152, ptr %239, align 8, !tbaa !47
...
243:                                              ; preds = %237
  ...
  %249 = load i32, ptr %11, align 8, !tbaa !24
...
254:                                              ; preds = %254, %251
  %255 = phi i64 [ 0, %251 ], [ %261, %254 ]
  %256 = load ptr, ptr %2, align 8, !tbaa !6
  %257 = getelementptr inbounds i8, ptr %256, i64 8
  %258 = load ptr, ptr %257, align 8, !tbaa !50
  %259 = tail call ptr %258(ptr noundef nonnull %0, i32 noundef signext 1, i64 noundef %248) #6
  %260 = getelementptr inbounds [4 x ptr], ptr %253, i64 0, i64 %255
  store ptr %259, ptr %260, align 8, !tbaa !23
  %261 = add nuw nsw i64 %255, 1
  %262 = load i32, ptr %11, align 8, !tbaa !24
  %263 = sext i32 %262 to i64
  %264 = icmp slt i64 %261, %263
  br i1 %264, label %254, label %265, !llvm.loop !51

265:                                              ; preds = %254, %243, %237
  ret void
}
...
18:                                               ; preds = %13
  store ptr @color_quantize3, ptr %17, align 8, !tbaa !54
  br label %293

19:                                               ; preds = %13
  store ptr @color_quantize, ptr %17, align 8, !tbaa !54
  br label %293
...
49:                                               ; preds = %52
  ...
  br i1 %51, label %61, label %52, !llvm.loop !57
...
68:                                               ; preds = %68, %61
  ...
  store i32 %168, ptr %169, align 4, !tbaa !35
  ...
  store i32 %198, ptr %199, align 4, !tbaa !35
  ...
  store i32 %228, ptr %229, align 4, !tbaa !35
  %230 = add nuw nsw i64 %69, 1
  %231 = icmp eq i64 %230, 16
  br i1 %231, label %232, label %68, !llvm.loop !58
...
234:                                              ; preds = %232, %57
  ...
  br i1 %240, label %43, label %293, !llvm.loop !59

241:                                              ; preds = %2
  %242 = getelementptr inbounds i8, ptr %4, i64 8
  store ptr @quantize_fs_dither, ptr %242, align 8, !tbaa !54
  %243 = getelementptr inbounds i8, ptr %4, i64 144
  store i32 0, ptr %243, align 8, !tbaa !60
...
261:                                              ; preds = %261, %259
  ...
  br i1 %271, label %261, label %272, !llvm.loop !51
...
281:                                              ; preds = %272, %281
  ...
  br i1 %288, label %281, label %293, !llvm.loop !61
...
55:                                               ; preds = %53, %55
  ...
  br i1 %64, label %55, label %65, !llvm.loop !63
...
68:                                               ; preds = %65, %47
  ...
  br i1 %75, label %76, label %47, !llvm.loop !64
...
80:                                               ; preds = %77, %80
  ...
  br i1 %87, label %88, label %80, !llvm.loop !65
...
88:                                               ; preds = %80, %76
  ...
  br i1 %92, label %24, label %93, !llvm.loop !66
...
27:                                               ; preds = %21, %27
  ...
  %49 = add i32 %29, -1
  %50 = icmp eq i32 %49, 0
  br i1 %50, label %51, label %27, !llvm.loop !67

51:                                               ; preds = %27
  %52 = add nuw nsw i64 %22, 1
  %53 = icmp eq i64 %52, %20
  br i1 %53, label %54, label %21, !llvm.loop !68
...
49:                                               ; preds = %34
  ...
  %53 = add i32 %31, -1
  %54 = icmp eq i32 %53, 0
  br i1 %54, label %55, label %30, !llvm.loop !70

55:                                               ; preds = %49
  %56 = add nuw nsw i64 %25, 1
  %57 = icmp eq i64 %56, %18
  br i1 %57, label %64, label %24, !llvm.loop !71
...
58:                                               ; preds = %19, %58
  ...
  br i1 %63, label %64, label %58, !llvm.loop !71
...
35:                                               ; preds = %28
  store i32 %32, ptr %18, align 4, !tbaa !55
  br label %95
...
50:                                               ; preds = %36, %50
  ...
  %88 = add i32 %52, -1
  %89 = icmp eq i32 %88, 0
  br i1 %89, label %90, label %50, !llvm.loop !73

90:                                               ; preds = %50
  %91 = add nsw i32 %37, 1
  %92 = and i32 %91, 15
  store i32 %92, ptr %18, align 4, !tbaa !55
  %93 = add nuw nsw i64 %38, 1
  %94 = icmp eq i64 %93, %24
  br i1 %94, label %95, label %36, !llvm.loop !72
...
28:                                               ; preds = %23, %28
  ...
  %32 = load i32, ptr %16, align 4, !tbaa !55
  %33 = add nsw i32 %32, 1
  %34 = and i32 %33, 15
  store i32 %34, ptr %16, align 4, !tbaa !55
  %35 = add nuw nsw i64 %29, 1
  %36 = icmp eq i64 %35, %25
  br i1 %36, label %94, label %28, !llvm.loop !74
...
55:                                               ; preds = %55, %44
  ...
  %75 = add i32 %57, -1
  %76 = icmp eq i32 %75, 0
  br i1 %76, label %77, label %55, !llvm.loop !75

77:                                               ; preds = %55
  %78 = add nuw nsw i64 %45, 1
  %79 = icmp eq i64 %78, %27
  br i1 %79, label %80, label %44, !llvm.loop !76

80:                                               ; preds = %77
  %81 = add nsw i32 %41, 1
  %82 = and i32 %81, 15
  store i32 %82, ptr %16, align 4, !tbaa !55
  %83 = add nuw nsw i64 %38, 1
  %84 = icmp eq i64 %83, %25
  br i1 %84, label %94, label %37, !llvm.loop !74
...
85:                                               ; preds = %21, %85
  ...
  %90 = add nsw i32 %89, 1
  %91 = and i32 %90, 15
  store i32 %91, ptr %16, align 4, !tbaa !55
  %92 = add nuw nsw i64 %86, 1
  %93 = icmp eq i64 %92, %22
  br i1 %93, label %94, label %85, !llvm.loop !74
...
38:                                               ; preds = %36, %51
  ...
  %42 = load i32, ptr %19, align 8, !tbaa !60
  %43 = icmp eq i32 %42, 0
...
44:                                               ; preds = %38, %44
  ...
  store i16 0, ptr %48, align 2, !tbaa !78
  %49 = add nuw nsw i64 %45, 1
  %50 = icmp eq i64 %49, %35
  br i1 %50, label %51, label %44, !llvm.loop !79

51:                                               ; preds = %44, %55
  %52 = zext i1 %43 to i32
  store i32 %52, ptr %19, align 8, !tbaa !60
  %53 = add nuw nsw i64 %39, 1
  %54 = icmp eq i64 %53, %34
  br i1 %54, label %155, label %38, !llvm.loop !80

55:                                               ; preds = %38, %55
  %56 = phi i64 [ %59, %55 ], [ 0, %38 ]
  %57 = getelementptr inbounds [4 x ptr], ptr %25, i64 0, i64 %56
  %58 = load ptr, ptr %57, align 8, !tbaa !23
  store i16 0, ptr %58, align 2, !tbaa !78
  %59 = add nuw nsw i64 %56, 1
  %60 = icmp eq i64 %59, %37
  br i1 %60, label %51, label %55, !llvm.loop !79
...
66:                                               ; preds = %61, %136
  ...
  %71 = load i32, ptr %19, align 8, !tbaa !60
  %72 = icmp eq i32 %71, 0
...
82:                                               ; preds = %79, %73
  ...
  %88 = load ptr, ptr %28, align 8, !tbaa !62
  %89 = getelementptr inbounds ptr, ptr %88, i64 %67
  %90 = load ptr, ptr %89, align 8, !tbaa !23
  %91 = load ptr, ptr %29, align 8, !tbaa !46
...
95:                                               ; preds = %95, %82
  ...
  store i16 %128, ptr %100, align 2, !tbaa !78
  ...
  br i1 %135, label %136, label %95, !llvm.loop !81

136:                                              ; preds = %95
  %137 = trunc nsw i32 %130 to i16
  store i16 %137, ptr %103, align 2, !tbaa !78
  %138 = add nuw nsw i64 %67, 1
  %139 = icmp eq i64 %138, %35
  br i1 %139, label %140, label %66, !llvm.loop !79

140:                                              ; preds = %136
  %141 = load i32, ptr %19, align 8, !tbaa !60
  %142 = icmp eq i32 %141, 0
  %143 = zext i1 %142 to i32
  store i32 %143, ptr %19, align 8, !tbaa !60
  %144 = add nuw nsw i64 %62, 1
  %145 = icmp eq i64 %144, %34
  br i1 %145, label %155, label %61, !llvm.loop !80
