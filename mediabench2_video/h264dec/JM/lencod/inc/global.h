...
extern Picture *frame_pic_1;
extern Picture *frame_pic_2;
extern Picture *frame_pic_3;
...
extern unsigned int *yPicPos;
extern unsigned int *xPicPos;
...
extern char    ***direct_ref_idx;           //!< direct mode reference index buffer
...
extern char b8_ipredmode8x8[4][4], b8_intra_pred_modes8x8[16];
...
extern int writeIPCMBytes(Bitstream *currStream);
extern int writePCMByteAlign(Bitstream *currStream);


extern int  dct_luma_sp2(int pos_mb1,int pos_mb2,int *cnt_nonz);
extern int  dct_chroma_sp2(int ,int);

extern int check_for_SI16();
extern int **lrec ;
extern int ***lrec_uv;
extern int si_frame_indicator;

extern int sp2_frame_indicator;
extern int number_sp2_frames;
...
extern int giRDOpt_B8OnlyFlag;

#ifdef BEST_NZ_COEFF
extern int gaaiMBAFF_NZCoeff[4][12];
#endif
