...
extern unsigned short  SymmetricalCrossSearchThreshold1;
extern unsigned short  SymmetricalCrossSearchThreshold2;
extern unsigned short  ConvergeThreshold;
extern unsigned short  SubPelThreshold1;
extern unsigned short  SubPelThreshold3;

extern byte  **simplified_SearchState;          //state for fractional pel search
extern int  ***simplified_fastme_l0_cost;       //store SAD information needed for forward median and uplayer prediction
extern int  ***simplified_fastme_l1_cost;       //store SAD information needed for backward median and uplayer prediction
extern byte   *simplified_flag_intra;
extern int     simplified_flag_intra_SAD;

extern int     simplified_pred_SAD_uplayer;     // Up layer SAD prediction
extern short   simplified_pred_MV_uplayer_X;    // Up layer MV predictor X-component
extern short   simplified_pred_MV_uplayer_Y;    // Up layer MV predictor Y-component
