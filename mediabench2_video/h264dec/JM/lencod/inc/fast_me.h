...
extern byte **McostState; //state for integer pel search
extern byte **SearchState; //state for fractional pel search

extern int ****fastme_ref_cost; //store SAD information needed for forward ref-frame prediction
extern int ***fastme_l0_cost; //store SAD information needed for forward median and uplayer prediction
extern int ***fastme_l1_cost; //store SAD information needed for backward median and uplayer prediction

extern int pred_SAD_space, pred_SAD_ref,pred_SAD_uplayer;  //SAD prediction
extern int pred_MV_ref[2], pred_MV_uplayer[2];             //pred motion vector by space or temporal correlation,Median is provided
