...
@.str = private unnamed_addr constant [11 x i8] c"chaining.c\00", align 1
@__func__.rs_sort_128x = private unnamed_addr constant [13 x i8] c"rs_sort_128x\00", align 1
@.str.1 = private unnamed_addr constant [22 x i8] c"n_bits <= RS_MAX_BITS\00", align 1
...
@.str.23 = private unnamed_addr constant [29 x i8] c"data/chianing_input_data.bin\00", align 1
@str = private unnamed_addr constant [14 x i8] c"chaining done\00", align 1
...
12:                                               ; preds = %4
  tail call void @__assert_func(ptr noundef nonnull @.str, i32 noundef signext 14, ptr noundef nonnull @__func__.rs_sort_128x, ptr noundef nonnull @.str.1) #14
  unreachable
...
declare dso_local void @__assert_func(ptr noundef, i32 noundef signext, ptr noundef, ptr noundef) local_unnamed_addr #4
...
276:                                              ; preds = %274
  tail call void @__assert_func(ptr noundef nonnull @.str, i32 noundef signext 125, ptr noundef nonnull @__func__.mg_chain_backtrack, ptr noundef nonnull @.str.2) #14
  unreachable
...
; Function Attrs: nofree nounwind
define dso_local void @load_input_data_from_file(ptr nocapture noundef readonly %0, i64 noundef %1, ptr nocapture noundef %2, ptr nocapture noundef %3, ptr nocapture noundef %4, ptr nocapture noundef %5, ptr nocapture noundef %6, ptr nocapture noundef %7, ptr nocapture noundef %8, ptr nocapture noundef %9, ptr nocapture noundef %10, ptr nocapture noundef %11, ptr nocapture noundef %12, ptr nocapture noundef %13, ptr nocapture noundef writeonly %14, ptr nocapture readnone %15, ptr nocapture readnone %16, ptr nocapture readnone %17) local_unnamed_addr #8 {
...
define dso_local noundef signext i32 @main(i32 noundef signext %0, ptr nocapture noundef readnone %1) local_unnamed_addr #3 {
  ...
  call void @load_input_data_from_file(ptr noundef nonnull @.str.23, i64 noundef 1000, ptr noundef nonnull %3, ptr noundef nonnull %4, ptr noundef nonnull %5, ptr noundef nonnull %6, ptr noundef nonnull %7, ptr noundef nonnull %8, ptr noundef nonnull %9, ptr noundef nonnull %14, ptr noundef nonnull %15, ptr noundef nonnull %10, ptr noundef nonnull %11, ptr noundef nonnull %12, ptr noundef nonnull %13, ptr nonnull poison, ptr nonnull poison, ptr nonnull poison)
  ...
  %25 = load float, ptr %14, align 4, !tbaa !50
  %26 = load float, ptr %15, align 4, !tbaa !50
  %27 = load i32, ptr %10, align 4, !tbaa !27
  %28 = load i32, ptr %11, align 4, !tbaa !27
  %29 = call ptr @mg_lchain_dp(i32 noundef signext %18, i32 noundef signext %19, i32 noundef signext %20, i32 noundef signext %21, i32 noundef signext %22, i32 noundef signext %23, i32 noundef signext %24, float noundef %25, float noundef %26, i32 noundef signext %27, i32 noundef signext %28, i64 noundef 1000, ptr noundef nonnull @sta, ptr noundef nonnull %16, ptr noundef nonnull %17, ptr noundef undef)
  %30 = load i64, ptr %29, align 8, !tbaa !10
  %31 = getelementptr inbounds i8, ptr %29, i64 8
  %32 = load i64, ptr %31, align 8, !tbaa !30
  %33 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 0, i64 noundef %30, i64 noundef %32)
  ...
  %38 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 1, i64 noundef %35, i64 noundef %37)
  ...
  %43 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 2, i64 noundef %40, i64 noundef %42)
  ...
  %48 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 3, i64 noundef %45, i64 noundef %47)
  %49 = getelementptr inbounds i8, ptr %29, i64 64
  %50 = load i64, ptr %49, align 8, !tbaa !10
  %51 = getelementptr inbounds i8, ptr %29, i64 72
  %52 = load i64, ptr %51, align 8, !tbaa !30
  %53 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 4, i64 noundef %50, i64 noundef %52)
  ...
  %58 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 5, i64 noundef %55, i64 noundef %57)
  %59 = getelementptr inbounds i8, ptr %29, i64 96
  %60 = load i64, ptr %59, align 8, !tbaa !10
  %61 = getelementptr inbounds i8, ptr %29, i64 104
  %62 = load i64, ptr %61, align 8, !tbaa !30
  %63 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 6, i64 noundef %60, i64 noundef %62)
  %64 = getelementptr inbounds i8, ptr %29, i64 112
  %65 = load i64, ptr %64, align 8, !tbaa !10
  %66 = getelementptr inbounds i8, ptr %29, i64 120
  %67 = load i64, ptr %66, align 8, !tbaa !30
  %68 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 7, i64 noundef %65, i64 noundef %67)
  %69 = getelementptr inbounds i8, ptr %29, i64 128
  %70 = load i64, ptr %69, align 8, !tbaa !10
  %71 = getelementptr inbounds i8, ptr %29, i64 136
  %72 = load i64, ptr %71, align 8, !tbaa !30
  %73 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 8, i64 noundef %70, i64 noundef %72)
  %74 = getelementptr inbounds i8, ptr %29, i64 144
  %75 = load i64, ptr %74, align 8, !tbaa !10
  %76 = getelementptr inbounds i8, ptr %29, i64 152
  %77 = load i64, ptr %76, align 8, !tbaa !30
  %78 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 9, i64 noundef %75, i64 noundef %77)
  %79 = getelementptr inbounds i8, ptr %29, i64 160
  %80 = load i64, ptr %79, align 8, !tbaa !10
  %81 = getelementptr inbounds i8, ptr %29, i64 168
  %82 = load i64, ptr %81, align 8, !tbaa !30
  %83 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 10, i64 noundef %80, i64 noundef %82)
  %84 = getelementptr inbounds i8, ptr %29, i64 176
  %85 = load i64, ptr %84, align 8, !tbaa !10
  %86 = getelementptr inbounds i8, ptr %29, i64 184
  %87 = load i64, ptr %86, align 8, !tbaa !30
  %88 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 11, i64 noundef %85, i64 noundef %87)
  %89 = getelementptr inbounds i8, ptr %29, i64 192
  %90 = load i64, ptr %89, align 8, !tbaa !10
  %91 = getelementptr inbounds i8, ptr %29, i64 200
  %92 = load i64, ptr %91, align 8, !tbaa !30
  %93 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 12, i64 noundef %90, i64 noundef %92)
  %94 = getelementptr inbounds i8, ptr %29, i64 208
  %95 = load i64, ptr %94, align 8, !tbaa !10
  %96 = getelementptr inbounds i8, ptr %29, i64 216
  %97 = load i64, ptr %96, align 8, !tbaa !30
  %98 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 13, i64 noundef %95, i64 noundef %97)
  %99 = getelementptr inbounds i8, ptr %29, i64 224
  %100 = load i64, ptr %99, align 8, !tbaa !10
  %101 = getelementptr inbounds i8, ptr %29, i64 232
  %102 = load i64, ptr %101, align 8, !tbaa !30
  %103 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 14, i64 noundef %100, i64 noundef %102)
  %104 = getelementptr inbounds i8, ptr %29, i64 240
  %105 = load i64, ptr %104, align 8, !tbaa !10
  %106 = getelementptr inbounds i8, ptr %29, i64 248
  %107 = load i64, ptr %106, align 8, !tbaa !30
  %108 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 15, i64 noundef %105, i64 noundef %107)
  %109 = getelementptr inbounds i8, ptr %29, i64 256
  %110 = load i64, ptr %109, align 8, !tbaa !10
  %111 = getelementptr inbounds i8, ptr %29, i64 264
  %112 = load i64, ptr %111, align 8, !tbaa !30
  %113 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 16, i64 noundef %110, i64 noundef %112)
  %114 = getelementptr inbounds i8, ptr %29, i64 272
  %115 = load i64, ptr %114, align 8, !tbaa !10
  %116 = getelementptr inbounds i8, ptr %29, i64 280
  %117 = load i64, ptr %116, align 8, !tbaa !30
  %118 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 17, i64 noundef %115, i64 noundef %117)
  %119 = getelementptr inbounds i8, ptr %29, i64 288
  %120 = load i64, ptr %119, align 8, !tbaa !10
  %121 = getelementptr inbounds i8, ptr %29, i64 296
  %122 = load i64, ptr %121, align 8, !tbaa !30
  %123 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 18, i64 noundef %120, i64 noundef %122)
  %124 = getelementptr inbounds i8, ptr %29, i64 304
  %125 = load i64, ptr %124, align 8, !tbaa !10
  %126 = getelementptr inbounds i8, ptr %29, i64 312
  %127 = load i64, ptr %126, align 8, !tbaa !30
  %128 = call signext i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef signext 19, i64 noundef %125, i64 noundef %127)
  %129 = call i32 @puts(ptr nonnull dereferenceable(1) @str)
...
attributes #4 = { noreturn "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic-rv64" "target-features"="+64bit,+a,+d,+f,+m,+relax,+zicsr,+zifencei,-c,-e,-experimental-smmpm,-experimental-smnpm,-experimental-ssnpm,-experimental-sspm,-experimental-ssqosid,-experimental-supm,-experimental-zalasr,-experimental-zfbfmin,-experimental-zicfilp,-experimental-zicfiss,-experimental-ztso,-experimental-zvfbfmin,-experimental-zvfbfwma,-h,-shcounterenw,-shgatpa,-shtvala,-shvsatpa,-shvstvala,-shvstvecd,-smaia,-smepmp,-smstateen,-ssaia,-ssccptr,-sscofpmf,-sscounterenw,-ssstateen,-ssstrict,-sstc,-sstvala,-sstvecd,-ssu64xl,-svade,-svadu,-svbare,-svinval,-svnapot,-svpbmt,-v,-xcvalu,-xcvbi,-xcvbitmanip,-xcvelw,-xcvmac,-xcvmem,-xcvsimd,-xsfcease,-xsfvcp,-xsfvfnrclipxfqf,-xsfvfwmaccqqq,-xsfvqmaccdod,-xsfvqmaccqoq,-xsifivecdiscarddlone,-xsifivecflushdlone,-xtheadba,-xtheadbb,-xtheadbs,-xtheadcmo,-xtheadcondmov,-xtheadfmemidx,-xtheadmac,-xtheadmemidx,-xtheadmempair,-xtheadsync,-xtheadvdot,-xventanacondops,-za128rs,-za64rs,-zaamo,-zabha,-zacas,-zalrsc,-zama16b,-zawrs,-zba,-zbb,-zbc,-zbkb,-zbkc,-zbkx,-zbs,-zca,-zcb,-zcd,-zce,-zcf,-zcmop,-zcmp,-zcmt,-zdinx,-zfa,-zfh,-zfhmin,-zfinx,-zhinx,-zhinxmin,-zic64b,-zicbom,-zicbop,-zicboz,-ziccamoa,-ziccif,-zicclsm,-ziccrse,-zicntr,-zicond,-zihintntl,-zihintpause,-zihpm,-zimop,-zk,-zkn,-zknd,-zkne,-zknh,-zkr,-zks,-zksed,-zksh,-zkt,-zmmul,-zvbb,-zvbc,-zve32f,-zve32x,-zve64d,-zve64f,-zve64x,-zvfh,-zvfhmin,-zvkb,-zvkg,-zvkn,-zvknc,-zvkned,-zvkng,-zvknha,-zvknhb,-zvks,-zvksc,-zvksed,-zvksg,-zvksh,-zvkt,-zvl1024b,-zvl128b,-zvl16384b,-zvl2048b,-zvl256b,-zvl32768b,-zvl32b,-zvl4096b,-zvl512b,-zvl64b,-zvl65536b,-zvl8192b" }
