...
# it is requried to export the following variables before running this script of makefile:
# Compiler
...
$RISCV_CC $RISCV_CFLAGS  -c  -march=rv64g -mabi=lp64d asm/${basename}_normal.S -o $3
