...
/home/heshds/working_dir/llvm-project/output-regsw/bin/clang -I/home/heshds/working_dir/regsw_tests/common/syscalls.c  --sysroot=/opt/dev/cva6_riscv_regsw/riscv-none-elf/ --gcc-toolchain=/opt/dev/cva6_riscv_regsw/ -O3 -S  -emit-llvm --target=riscv64  -march=rv64g  $1 -o LLVM/${basename}_extra.ll
